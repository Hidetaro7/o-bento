...
class HistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create history" do
    assert_difference('History.count') do
      post histories_url, params: { history: { destination: @history.destination, history_at: @history.history_at, user_id: @history.user_id } }
    end
  ...
  test "should update history" do
    patch history_url(@history), params: { history: { destination: @history.destination, history_at: @history.history_at, user_id: @history.user_id } }
